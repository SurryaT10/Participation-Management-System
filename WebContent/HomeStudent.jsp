...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item">
        <a class="nav-link" href="EditProfileStudent.jsp">Edit Profile</a>
      </li>
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
          <a class="dropdown-item" href="GetMyCertificate.jsp">Your Certificates</a>
          <a class="dropdown-item" href="upload.jsp">Add New Certificates</a>
          <!--<div class="dropdown-divider"></div>
          <a class="dropdown-item" href="#" onclick="suba()">More</a>-->
        </div>
      </li>
      <li  class="nav-item">
      <a class="nav-link" href="GetNotifications">Notifications</a>
      </li>
    <li  class="nav-item">
      <a class="nav-link" href="ViewPerformance.jsp">Performance</a>
      </li>
      <li  class="nav-item">
